...
public class ProcessInfo {
	...
	public final class ProcessInfoSnapshot {
		...
		public long getParentPid() throws RuntimeException {
			return (ProcessInfo.this.procState != null) ? ProcessInfo.this.procState.getPpid() : 0L;
		}

		public ProcState getState() throws RuntimeException {
			return ProcessInfo.this.procState;
		}

		public ProcExe getExecutable() throws RuntimeException {
			return ProcessInfo.this.procExe;
		}

		public ProcTime getTime() throws RuntimeException {
			return ProcessInfo.this.procTime;
		}

		public ProcMem getMemory() throws RuntimeException {
			return ProcessInfo.this.procMem;
		}

		public ProcCpu getCpu() throws RuntimeException {
			return ProcessInfo.this.procCpu;
		}

		public ProcFd getFileDescriptor() throws RuntimeException {
			return ProcessInfo.this.procFd;
		}

		public ProcCred getCredentials() throws RuntimeException {
			return ProcessInfo.this.procCred;
		}

		public ProcCredName getCredentialsName() throws RuntimeException {
		 ...
		 */
		public String getCurrentWorkingDirectory() throws RuntimeException {
			String result = null;
			try {
	...
	public ProcessInfo(long pid, SigarProxy sigar) throws RuntimeException {
		this.pid = pid;
		this.sigar = sigar;
		update(pid);
	}
	...
	private void update(long pid) throws RuntimeException {
...
/*    public AggregateProcessInfo getAggregateProcessTree() {
	 ...
	 * @since 4.4
	 */
	public ProcessInfo getParentProcess() throws RuntimeException {
