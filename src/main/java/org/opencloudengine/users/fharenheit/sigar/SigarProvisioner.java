package org.opencloudengine.users.fharenheit.sigar;
...
public class SigarProvisioner {
	 ...
	 */
	public static final String ENVIRONMENT_VARIABLE = "FLAMINGO_SIGAR_FOLDER";

	/**
	 * System property which provides sigar extract location.
	 */
	public static final String SYSTEM_PROPERTY = "flamingo.sigar.folder";
	 ...
	 *
	 * @param folder Library extraction folder.
	 * @throws Exception The provisioning failure exception.
	 */
